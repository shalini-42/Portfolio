export const project_list =[
    {
     ...
     
      {
        ...
        img_src: `/project/ecommerce.png`,
         description:"An E-commerce system is an online platform that allows users to buy and sell products or services through the internet. It provides features such as product listing, search and filtering, user registration, shopping cart, secure online payment, and order tracking. Customers can browse products, add items to the cart, place orders, and make payments from anywhere at any time.",
        features:[""],
        tools:[
          "HTML",
          "Bootstrap",
        ...
        github:"https://github.com/shalini-42/react-e-commerce",
